...
public interface IFileClient
{
    ...
    public Task<ErrorOr<GetFileUsage.Response>> GetFileUsage(CancellationToken ct = default);
    public Task<ErrorOr<IReadOnlyCollection<FileIdentifier>>> GetBlogposts(CancellationToken ct = default);
}