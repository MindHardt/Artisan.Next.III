...
public partial class NewCharacter
{
    ...
    private string PrepareSvg() => SvgPreparationRegex().Replace(PreparePortrait(),
        match => match.Groups["NAME"].Value switch
        {
            ...
            "СИЛ" => Character.CalculateCharacteristics().Strength.AsModifier(),
            "ЛВК" => Character.CalculateCharacteristics().Dexterity.AsModifier(),
            "ВЫН" => Character.CalculateCharacteristics().Constitution.AsModifier(),
            "ИНТ" => Character.CalculateCharacteristics().Intelligence.AsModifier(),
            "МДР" => Character.CalculateCharacteristics().Wisdom.AsModifier(),
            "ХАР" => Character.CalculateCharacteristics().Charisma.AsModifier(),
