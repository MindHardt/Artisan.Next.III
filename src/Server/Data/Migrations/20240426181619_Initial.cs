    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UrlName = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Books", x => x.UrlName);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Files_Hash_Identifier",
                table: "Files",
                columns: new[] { "Hash", "Identifier" })
                .Annotation("Npgsql:IndexInclude", new[] { "Scope", "OriginalName" });
